...
% 
% %% 转灰度
% map1=imread('Fr1_3.png','png');%rgb2gray
% map1=map1(:,:,1);
% % map2=rgb2gray(imread('Fr2_3.png','png'));
% map1 = imresize(map1,1.0);
% map2 = imresize(map1,1.3);
...
%  cornersM1=harrislaplace(map1);
%  cornersM2=harrislaplace(map2);
% %  draw(map1,cornersM1,'m1');
% %  draw(map2,cornersM2,'m2');
%  figure;imshow(map1);hold on
%  showCornerScale(cornersM1);
%  figure;imshow(map2);hold on
%  showCornerScale(cornersM2);
%  
%  cornersM1=SURFPoints(cornersM1(:,1:2),'Scale',cornersM1(:,3));
%  cornersM2=SURFPoints(cornersM2(:,1:2),'Scale',cornersM2(:,3));
% 
% %% 选取harris特殊点 
